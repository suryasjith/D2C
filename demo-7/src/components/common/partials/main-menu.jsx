            ...
            <ul className="menu sf-arrows">
                ...
                <li className={ path.indexOf( "element" ) > -1 ? 'active' : '' }>
                    {isAuthenticated() && isAuthenticated().user.role === 1 && (
                        <Link to={ `${process.env.PUBLIC_URL}/shop/admin/dashboard` } className="sf-with-ul">My Profile</Link>
                    )}
                    {isAuthenticated() && isAuthenticated().user.role === 0 && (
                        <Link to={ `${process.env.PUBLIC_URL}/shop/dashboard` } className="sf-with-ul">My Profile</Link>
                    )}
                </li>
                <li className={ path.indexOf( "pages" ) > -1 ? 'active' : '' }>
                    <Link to={ `/pages/contact-2` } className="sf-with-ul">Contact</Link>
                ...
                <li className={ path.indexOf( "blog/" ) > -1 ? 'active' : '' }>
                    <Link to={ `/pages/about-2` } className="sf-with-ul">About</Link>
