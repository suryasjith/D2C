...
export default function ProductsRoute() {
    return (
        <Switch>
            <Layout>
                <Route exact path={ `/product/default/:id` } component={ Default } />
                <Route exact path={ `/product/centered/:id` } component={ Centered } />
                <Route exact path={ `/product/extended/:id` } component={ ExtendedInfo } />
                <Route exact path={ `/product/gallery/:id` } component={ Gallery } />
                <Route exact path={ `/product/sticky/:id` } component={ StickyInfo } />
                <Route exact path={ `/product/sidebar/:id` } component={ Sidebar } />
                <Route exact path={ `/product/fullwidth/:id` } component={ Fullwidth } />
                <Route exact path={ `/product/masonry/:id` } component={ Masonry } />
            </Layout>
        </Switch>
    );
}